...
if __name__ == "__main__":
    ...
    tab1, tab2= st.tabs(["Choose location to compare parameters", "Choose parameter to compare locations"])
    with tab1:
    ...
    st.sidebar.title("Details of parameters")

    st.sidebar.write("""
        A Parameter in the OpenAQ platform is the type of particle or gaseous pollutant measured. 
                     
        Please click through the parameters below for further infomation.
    """)

    with st.sidebar.expander("Particulate matter"):
        st.write("""
        ...
        """)
    with st.sidebar.expander("Nitrogen Monoxide"):
    ...
    with st.sidebar.expander("Nitrogen Dioxide"):
    ...
    with st.sidebar.expander("Nitrogen Dioxide"):
        st.write("NO₂ - Nitrogen Dioxide concentration in micrograms per cubic meter (µg/m³), parts per billion (ppb), and parts per million (ppm). It\'s a reddish-brown gas emitted from combustion processes and contributes to respiratory problems and environmental damage.")
    with st.sidebar.expander("Nitrogen Oxides"):
    ...
    with st.sidebar.expander("Sulfur Dioxide"):
    ...
    with st.sidebar.expander("Ozone"):
    ...
    with st.sidebar.expander("Carbon Monoxide"):
    ...
    with st.sidebar.expander("Carbon Dioxide concentration"):
    ...
    with st.sidebar.expander("Black Carbon concentration"):
    ...
    with st.sidebar.expander("Volatile Organic Compounds"):
    ...
    with st.sidebar.expander("Pressure"):
    ...
    with st.sidebar.expander("Humidity"):
    ...
    with st.sidebar.expander("Relative Humidity"):
